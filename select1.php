...
//$sql = "SELECT * FROM `Product` WHERE name = 'nazwa1'";
//$sql = "SELECT * FROM `Product` WHERE name LIKE 'nazwa%'";
//$sql = "SELECT description AS opis_pola FROM `Product`";
$sql = "SELECT * FROM `Product` ORDER BY description DESC";
